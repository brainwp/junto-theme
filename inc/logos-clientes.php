<?php
// Mostra o thumbnail dos anexos no admin da pagina/post
...
function images_init(){
	...
	foreach ( $post_types as $post_type ) {
		add_meta_box("my-images", "Logos de Clientes - Selecione quais logos deseja exibir", "images_link", $post_type, "normal", "low");
	}
}
...
jQuery(document).ready(function($){
  $('.frame input').change(function() {
	...
	$('.count-selected').text('Selecionados: '+result.length);
