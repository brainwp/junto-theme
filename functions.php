...
if (!function_exists('junto_theme_setup')) :
    function register_onepage_posts()
    {
        if (isset($_GET['activated']) && is_admin()){
            ...
            $into = get_page_by_path('cases', OBJECT, 'onepage');
            if (empty($into)) {
            ...
            $into = get_page_by_path('clientes', OBJECT, 'onepage');
            if (empty($into)) {
            ...
            $into = get_page_by_path('portfolio', OBJECT, 'onepage');
            if (empty($into)) {
                $defaults = array(
                    'post_status' => 'publish',
            ...
            $into = get_page_by_path('metodologia', OBJECT, 'onepage');
            if (empty($into)) {
                $defaults = array(
                    'post_status' => 'publish',
            ...
            $into = get_page_by_path('servicos', OBJECT, 'onepage');
            if (empty($into)) {
                $defaults = array(
                    'post_status' => 'publish',
            ...
            $into = get_page_by_path('missao', OBJECT, 'onepage');
            if (empty($into)) {
                $defaults = array(
                    'post_status' => 'publish',
...
function junto_theme_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('Newsletter', 'junto-theme'),
        'id' => 'newsletter_widget_area',
        'description' => 'Adicione aqui apenas o widget de Newsletter (Alo Easymail Widget)',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h1 class="widget-title">',
        'after_title' => '</h1>',
    ...
    register_sidebar(array(
        'name' => __('Social Icons', 'junto-theme'),
        'id' => 'social_icons_widget_area',
        'description' => 'Adicione aqui apenas o widget de Social Icons (Simple Social Icons)',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h1 class="widget-title">',
        'after_title' => '</h1>',
